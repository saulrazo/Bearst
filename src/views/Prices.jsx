...
import '../components/styles/Prices.css'
...
function Prices(){
    return (
        <Layaout>
            <Helmet>
            <title>Bearst.com.mx: Servicios | Servicios profesionales de diseño web
            </title>
            <meta name="description" content="
            Checa nuestros servicios de Diseño Web.
            ...
            " />
            <link rel="canonical" href="https://bearst.com.mx/prices" />
            </Helmet>
        <div className="Cont1">
            <h1 style={{
                textAlign:"center",
                marginTop:"5vh"
            }}>Nuestras <br /><span style={{
                color:"#00a8e8"
            }}>Páginas Web</span></h1>

            <a className="Basic" href="#Basic">
                <h2 className="Bas">Básica</h2>
                <br className="BasBr" />
                <p className="moreInfoBasic">Con recursos básicos para
                referenciar a tus próximos clientes</p>
            </a>
            <a className="Premium" href="#Premium">
                <h2 className="Prem">Premium</h2>
                <br className="PremBr" />
                <p className="moreInfoPremium">Integra más recursos de contacto y
                una calidad especial.</p>
            </a>
        </div>

        <div className="Cont2" id="Basic">
            
            <svg  xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid meet" version="1.0" viewBox="7.7 20.8 269.2 76.3" zoomAndPan="magnify" 
            className="flecha1" role="img" aria-label="Brushstroke Arrow Rapid Curved Long">
                <g id="__id29_s0d6ywung8" className="flecha2">
                    ...
                    className="flecha3"></path><path className="flecha4" d="M48.31,55.46c0.29,0.2,0.58,0.39,0.86,0.59C49.03,55.63,48.74,55.44,48.31,55.46z"></path></g></svg>
            <h1 style={{
                textAlign:"center",
                marginTop:"5vh",
                color:"#003459 "
            }}>Página Web <br /><span className="BasicTitle" style={{
                fontWeight:"bold"
            }}>Básica</span></h1>
            <h2 className="Q" style={{
                backgroundColor:"#00a8e8"
            }}>¿Qué incluye?</h2>
            <br />
            <br />
            <div className="MainBasicList">
                <ul className="BasicList">
                <li>Landing Page de 4 secciones               
                    <ul>
                        <li>(Home, Nosotros, Servicios, Clientes)</li>
                    </ul>
                </li>
                ...
                <li>Diseño responsivo 
                    <ul>
                        <li>(Adaptable a dispositivos móviles)</li>
                    </ul>
                </li>
            </ul>
            </div>
        ...
        <div className="Cont3" id="Premium">
            <h1 style={{
                textAlign:"center",
                marginTop:"5vh",
                color:"white"
            }}>Página Web <br /><span className="PremiumTitle" style={{
                fontWeight:"bold"
            }}>Premium</span></h1>
            <h2 className="Q" style={{
            ...
            <br />
            <br />
            <div className="MainPremiumList">
                <ul className="PremiumList">
                <li>Diseño altamente personalizado</li>
                <li>5 secciones principales a elección</li>
                <li>Galería de multimedia</li>
                <li>Botón de Whatsapp business o Messenger</li>
                <li>Diseño responsivo 
                    <ul>
                        <li>( Adaptable a dispositivos móviles)</li>
                    </ul>
        ...
        <div className="Cont4">
            ...
            <ul className="list">
                <li><CgArrowLongRight size={80} className="arrow"/>
                    <br />
                    50% del costo del proyecto tendrá que
                    liquidarse para comenzar este, una vez
                    concluido, se liquida lo restante.</li>
                <li><CgArrowLongRight size={80} className="arrow"/>
                    <br />
                    Los impuestos ya están incluidos</li>
                <li><CgArrowLongRight size={80} className="arrow"/>
                    <br />
                    Duración del proyecto: 7 a 14 días hábiles</li>
                <li><CgArrowLongRight size={80} className="arrow"/>
                    <br />
                    No se contemplan los cambios del
                    cliente en la duración del proyecto</li>
                <li><CgArrowLongRight size={80} className="arrow"/>
                    <br />
                    Hosting, dominio y herramientas
                    adicionales no están incluidas</li>
            </ul>
        </div>
        </Layaout>
    )
